package com.example.lzw.zyfypt_303_lzw.fragment.project;
...
public class Project2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_project_2, container, false);
            recyclerViewinit();

            for (int p = 1; p < 7; p++) {
                resourceModel.getResultList("project", p, sessionid, listener);
            }
    ...
    private void loadMoreData() {
        page += 1;
        if (page < 10) {
            resourceModel.getResultList("project", page, sessionid, listener);
        }
