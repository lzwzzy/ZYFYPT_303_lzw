...
public class Video2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_video_2, container, false);
            recyclerViewinit();
            for (int p = 1; p < 11; p++) {
                resourceModel.getResultList("video", p, sessionid, listener);
            }
    ...
    private void loadMoreData() {
        page += 1;
        if (page < 10) {
            resourceModel.getResultList("video", page, sessionid, listener);
        }
