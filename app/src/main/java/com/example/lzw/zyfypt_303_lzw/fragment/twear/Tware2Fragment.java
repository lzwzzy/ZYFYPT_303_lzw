...
public class Tware2Fragment extends Fragment {
    private int page = 1;
    private int count = 0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_tware_2, container, false);
            recyclerViewinit();
            for (int p = 1; p < 3; p++) {
                resourceModel.getResultList("tware", p, sessionid, listener);
            }
    ...
    private void recyclerViewinit() {
        ...
        //获取布局上的控件，注意通过view获取
        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerView_tware);
    ...
    private void loadMoreData() {
        page += 1;
        if (page < 10) {
            resourceModel.getResultList("tware", page, sessionid, listener);
        }
